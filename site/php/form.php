...
//le_put_contents($file, "tel:_".$tel ."__name:". $name);
  ...
  mail('aurumstroy@remont-tomsk.ru', 'My Subject', $message, $headers);
header("Location: https://remont-tomsk.ru/");
}else{
...
$error = true;
    $secret = '6Lf5jtgpAAAAADYWRcRnTQUhMBfMpLDpIb7J8Gio';
